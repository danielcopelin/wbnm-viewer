...
SOURCES = \
	__init__.py \
	wbnm_viewer.py wbnm_viewer_dockwidget.py

PLUGINNAME = wbnm_viewer

PY_FILES = \
	__init__.py \
	wbnm_viewer.py wbnm_viewer_dockwidget.py

UI_FILES = wbnm_viewer_dockwidget_base.ui
...
QGISDIR=C:\Users\danie\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
